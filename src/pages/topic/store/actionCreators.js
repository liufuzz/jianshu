...
export const getRecommendList = () => {
  return (dispatch) => {
    axios.get('/api/topic/recommend.json').then((res) => {
...
export const handleHotClick = () => {
  return (dispatch) => {
    axios.get('/api/topic/hot.json').then((res) => {
      const result = res.data.recommendList;
...
export const handleCityClick = () => {
  return (dispatch) => {
    axios.get('/api/topic/city.json').then((res) => {
      const result = res.data.recommendList;
...
export const handleCampusClick = () => {
  return (dispatch) => {
    axios.get('/api/topic/campus.json').then((res) => {
      const result = res.data.recommendList;
